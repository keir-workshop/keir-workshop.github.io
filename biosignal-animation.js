class BiosignalAnimation {
    constructor() {
        ...
        // Configuration
        this.config = {
            rowCount: 10, // full-header coverage
            ...
            rotation: 8, // degrees
            icons: [
                'assets/keir/graph.svg',
                'assets/keir/doc.svg',
                'assets/keir/lens.svg',
                'assets/keir/agent.svg',
                'assets/keir/database.svg',
                'assets/keir/book.svg',
                'assets/keir/ranking.svg',
                'assets/keir/embedding.svg',
                'assets/keir/link.svg',
                'assets/keir/table.svg',
                'assets/keir/query.svg',
                'assets/keir/pipeline.svg',
            ]
        };
